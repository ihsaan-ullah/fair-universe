...
| --- | ---------------------------- | ------------------------------------------------------------------------------------------------- |
| 1.  | EventId                      | An unique integer identifier of the event.                                                       |
...
| 15. | Eletron Flag                 | 1 of its an electron 0 if its not.                                                               |
| 16. | muon Flag                    | 1 of its an muon 0 if its not.                                                                   |
...
| 25. | PRI_jet_num                  | The number of jets (integer with value of 0, 1, 2 or 3; possible larger values have been capped at 3). |
| 26. | PRI_jet_leading_pt           | The transverse momentum $\sqrt{{p_x}^2 + {p_x}^2}$ of the leading jet, that is the jet with largest transverse momentum (undefined if PRI_jet_num = 0). |
...
| 29. | PRI_jet_subleading_pt        | The transverse momentum $\sqrt{{p_x}^2 + {p_x}^2}$ of the leading jet, that is, the jet with second largest transverse momentum (undefined if PRI_jet_num ≤ 1). |
...
| 33. | Label                        | The event label $y_i \in \{1,0\}$ (1 for signal, 0 for background).                               |
