...
class Ingestion():
    ...
    def predict_submission(self):
        ...
        self.delta_mu_hats = predicted_dict["delta_mu_hats"]

        self.p16 = predicted_dict["p16"]
        self.p84 = predicted_dict["p84"]
    ...
    def save_result(self):
        ...
        print(f"[*] --- delta_mu_hats (avg): {np.mean(result_dict['delta_mu_hats'])}")
